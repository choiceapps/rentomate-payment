...
const [loading, setLoading] = useState(false);
    ...
    const handleSubmit = async (e) => {
        ...
        if(password.length < 8){
            ...
            await axios.post("http://localhost:4000/landlord", users).then((res) => {
    ...
    <div className={Style.container}>
        ...
        <div className={Style.formFooter}>
            ...
            <Link className={Style.caButton} to="/user/sing-up">Create tenant account</Link>
        </div>
    </div>
</section>
    );
