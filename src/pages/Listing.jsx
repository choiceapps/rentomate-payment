...
const Listing = () => {
    ...
    useEffect(() => {
        axios.get("http://localhost:4000/rent/").then((res) => {
            setRent(res.data)
        }).catch((err) => {
            setError(err)
        })
            ...
            <div className={Style.listings}>
                {
                    ...
                    <div className={Style.itembody}>
                        <span>
                            <h2>Find Tenants</h2>
                            <Link to={`/single/${item._id}`} state={item}>Listing Inquiries, application <FaChevronCircleRight /></Link>
                        </span>
                    ...
                    <div className={Style.itemfooter}>
                        <span>
                            ...
                            <Link to={`/edit/${item._id}`} state={item}>Leases, Payments <FaChevronCircleRight /></Link>
                        </span>
