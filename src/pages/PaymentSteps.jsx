...
const PaymentSteps = (props) => {
  ...
  // const [upRent, setupRent] = useState("")
  ...
  useEffect(() => {
    const updateRentData = async () => {
      ...
      await axios.put(
        import.meta.env.VITE_BACKEND_DOMAIN + `/rent/${id}`,
        data
      );
    };
    if (payId) {
  ...
  const getConnectURL = async () => {
    ...
    try {
      const res = await axios.get(
        import.meta.env.VITE_BACKEND_DOMAIN + "/connect"
      );
  ...
  const handleSubmit = async (e) => {
    ...
    if (relentedCost.length === 0) {
      ...
      setLoading(true);
      await axios
        .post(import.meta.env.VITE_BACKEND_DOMAIN + "/rent", data)
        .then((res) => {
        ...
        <form onSubmit={handleSubmit}>
          {step === 0 && (
            <div className={Style.CostInfo}>
              ...
              <ul>
                <li>
                  Bank account info for what you&apos;d like to recive payments
                </li>
                <li>Amounts for the monthly rent and any move in charges</li>
                <li>Basic details about your renter</li>
                <li>
                  Your social security number and/or employer idententification
                  number (EN), plus a physical mailing address
                </li>
              </ul>
            </div>
          )}
          {step === 1 && (
            <div className={Style.rentInfo}>
              ...
              <p>
                ...
                minus voluptatibus minima ducimus aliquam enim nobis cumque
          ...
          {step === 6 && (
            <div className={Style.CostInfo}>
              ...
              <div
                className={isShowthree ? Style.conActive : Style.conDeactive}
              >
                {inputList &&
          ...
          {step === 8 && (
            <div className={Style.CostInfo}>
              ...
              <h4 onClick={getConnectURL} className={Style.button}>
                <FaLock /> {response ? "Loading..." : "Link My Bank Account"}
              </h4>
              <p>(Fastet)you need only your bank login info.</p>
              <h4 className={Style.manualButton}>
                Manualy enter account information
              </h4>
          ...
          {step === 0 ? (
            ...
            <h4 className={Style.button} onClick={onClick}>
